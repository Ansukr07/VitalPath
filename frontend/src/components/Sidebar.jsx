...
const PATIENT_LINKS = [
    ...
    { icon: Sparkles, label: 'Suggestions', path: '/patient/suggestions', id: 'suggestions' },
    { icon: Bell, label: 'Reminders', path: '/patient/reminders', id: 'reminders' },
    { icon: User, label: 'Profile', path: '/patient/profile', id: 'profile' },
];

const DOCTOR_LINKS = [
    { icon: Hospital, label: 'Dashboard', path: '/doctor', id: 'dashboard' },
    { icon: AlertCircle, label: 'Alerts', path: '/doctor#alerts', id: 'alerts' },
];
...
export default function Sidebar() {
    ...
    return (
        ...
        >
            {isPatient ? (
                <>
                    <div className="pd-logo" style={{ background: '#3b82f6', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
